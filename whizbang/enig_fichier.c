...
void init_enig_fichier( enig_fichier* en ,SDL_Color Color)
{
    ...
    en->resultat = 0;
    en->correct =IMG_Load("correct1.png");
    en->wrong =IMG_Load("wrong1.png");
    en->position_correct.x = 170;
    en->position_correct.y = 285;
    ...
    en->reponse_2 = NULL;
    en->pos_reponse_2.x=500;
    en->pos_reponse_2.y=500;

    en->reponse_3 =NULL;
    en->pos_reponse_3.x=750;
    ...
    while(continuer == 1)
    {
        ...
        case SDL_MOUSEBUTTONDOWN:
        {
            ...
            case SDL_BUTTON_LEFT:
            {
                ...
                if ( event.button.x>500 && event.button.x<600 && event.button.y>500 && event.button.y<600) //reponse2
                {
                    if ( en->alea == 1 )
                    {
                        en->resultat= 2;
                ...
                if ( event.button.x>750 && event.button.x<850 && event.button.y>500 && event.button.y<600) //reponse3
                {
                    if ( en->alea == 1 )
                    {
                        en->resultat= 2;
